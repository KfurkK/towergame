...
public class Enemy {
    ...
    public void damage(double amount) {
    	//  System.out.println("🟥 Hasar alındı: -" + amount);
        this.health -= amount;
        //  System.out.println("🟨 Kalan can: " + this.health + " / " + this.maxHealth);
    ...
    // Position getters
    public double getX() {
        return enemyCircle.getTranslateX();
    }

    public double getY() {
    	return enemyCircle.getTranslateY();
    }
}